...
EXCEPTION
	WHEN NO_DATA_FOUND THEN
		RAISE_APPLICATION_ERROR (-20002, 'No existe la consulta');
	WHEN OTHERS THEN
		RAISE_APPLICATION_ERROR (-20100, 'Error desconocido');
...
EXCEPTION
	WHEN NO_DATA_FOUND THEN
		RAISE_APPLICATION_ERROR (-20003, 'No existe la consulta');
	WHEN validez THEN
...
EXCEPTION
	WHEN NO_DATA_FOUND THEN
		RAISE_APPLICATION_ERROR (-20004, 'No existe el medico especialista');
	WHEN OTHERS THEN
		RAISE_APPLICATION_ERROR (-20100, 'Error desconocido');
END derivarEsp;
/
